...
correct solution! [{\it Side note: it is actually a solution for two
|cray_ban|{\kern-1pt} in series.}] And, indeed, it gives incorrect
results. If you plug in the angles $\phi_{01}=\pi/4$
